...
export const AddWindowsButton = ({ data }) => {
  ...
  const onRiskObjectPropertiesRecoilCallback = useRecoilCallback(
    ({ set }) =>
      async (response) => {
  ...
  const onRiskAssessmentPhysicalTableRecoilCallback = useRecoilCallback(
    ({ set }) =>
  ...
  const onRiskAssessmentTableRecoilCallback = useRecoilCallback(
    ({ set }) =>
      async (name, data) => {
        const generatedId = generateID();
  ...
  const onAssociationsRecoilCallback = useRecoilCallback(
    ({ set }) =>
      (data) => {
        const generatedId = generateID();
  ...
  const onEntitiesRecoilCallback = useRecoilCallback(
    ({ set }) =>
      async (data) => {
        const generatedId = generateID();
  ...
  const onSequenceFlowsRecoilCallback = useRecoilCallback(
    ({ set }) =>
      (data) => {
        const generatedId = generateID();
  ...
  const onLanesRecoilCallback = useRecoilCallback(
    ({ set }) =>
      async (data) => {
        const generatedId = generateID();
  ...
  const onLevelRecoilCallback = useRecoilCallback(
    ({ set }) =>
      (levelData) => {
        const generatedId = generateID();
